    ...
    return (<form action={handleSubmit}>
                <div className="grid gap-4 py-4">
                    ...
                    <div className="flex justify-end">
                        <Button className="rounded-lg bg-gradient-to-r from-brand-300 via-brand-400 to-brand-600 px-5 py-2.5 text-center text-sm font-bold text-white hover:bg-gradient-to-bl">Edit Category</Button>
                    </div>
                </div>
            </form>)
}