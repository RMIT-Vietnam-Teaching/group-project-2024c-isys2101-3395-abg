...
export function CartProductList() {
    return (
        <div className="mx-auto w-full flex-none lg:max-w-2xl xl:max-w-4xl">
            <h2 className="text-xl my-3 font-semibold text-brand-600 sm:text-2xl">Shopping Cart</h2>
                ...
                <div className="rounded-lg border border-gray-200 bg-brand-600 p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                    <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                        ...
                        <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                            <a href="#" className="text-base font-medium text-brand-100 hover:underline">EBC Double-H Sintered Brake Pads - FA244HH</a>
